...
meara = User.create(first_name: 'Meara', last_name: 'Charnetzki', email: 'meara@dbc.com', password_digest: 1)
peter = User.create(first_name: 'Peter', last_name: 'Pan', email: 'pete@pan.com', password_digest: 1)
